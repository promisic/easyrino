...
AppPublisherURL=https://github.com/promisic/easyrino
...
OutputBaseFilename= easyrino_1.0_setup
...
Source: "..\EasyRino\bin\Debug\EasyRino.exe"; DestDir: "{app}\bin"; 
Source: "..\EasyRino\bin\Debug\GriffinSoft.EasyRino.RinoCore.dll"; DestDir: "{app}\bin"; 
Source: "..\EasyRino\bin\Debug\GriffinSoft.EasyRino.RinoXmlFilter.dll"; DestDir: "{app}\bin";
Source: "..\gpl_license.txt"; DestDir: "{app}\bin";
Source: "..\doc\easyrino_manual.pdf"; DestDir: "{app}\doc"; 

[Icons]
; Icons to create
Name: "{group}\EasyRino"; Filename: "{app}\bin\EasyRino.exe"; IconFilename: "{app}\bin\EasyRino.exe"; WorkingDir: "{app}\bin";
Name: "{userdesktop}\EasyRino"; Filename: "{app}\bin\EasyRino.exe"; IconFilename: "{app}\bin\EasyRino.exe"; WorkingDir: "{app}\bin";
